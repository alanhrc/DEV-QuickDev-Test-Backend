...
INSERT INTO "new_comments" ("created_at", "description", "id", "post_id", "removeOwnerPost", "updated_at", "user_id") SELECT "created_at", "description", "id", "post_id", "removeOwnerPost", "updated_at", "user_id" FROM "comments";
DROP TABLE "comments";
